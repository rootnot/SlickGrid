...
(function ($) {
  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function init() {
      ...
      $headers = $("<div class='slick-header-columns' style='width:12000px; left:-1000px' />").appendTo($headerScroller);

      $headerRowScroller = $("<div class='slick-headerrow ui-state-default' style='overflow:hidden;position:relative;' />").appendTo($container);
      $headerRow = $("<div class='slick-headerrow-columns' />").appendTo($headerRowScroller);

      $topPanelScroller = $("<div class='slick-top-panel-scroller ui-state-default' style='overflow:hidden;position:relative;' />").appendTo($container);
      $topPanel = $("<div class='slick-top-panel' style='width:12000px' />").appendTo($topPanelScroller);
    ...
    function bindAncestorScrollEvents() {
        console.log('bindAncestorScrollEvents');
    ...
    function appendRowHtml(stringArray, row) {
        // console.log('appendRowHtml');
        
        var dataItem    = getDataItem(row);
        var dataLoading = row < getDataLength() && !dataItem;
        var cellCss;
        ...
        for (var i = 0, cols = columns.length; i < cols; i++) {
            ...
            if (dataItem) {
                var value = getDataItemValueForColumn(dataItem, m);
                stringArray.push(getFormatter(row, m)(row, i, value, m, dataItem));
            }
...
// 
    ...
    function flashCell(row, cell, speed) {
        console.log('flashCell', arguments);
        speed = speed || 100;
